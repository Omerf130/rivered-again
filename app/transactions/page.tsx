...
export default function Transactions() {
  ...
  const [editFormData, setEditFormData] = useState({ transaction: "", amount: "" });
  ...
  const handleCancelEdit = () => {
    setEditingId(null);
    setEditFormData({ transaction: "", amount: "" });
  };
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/transactions/${editingId}`, {
        ...
        body: JSON.stringify({
          transaction: editFormData.transaction,
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Edit Transaction Form (shown when editing) */}
        {editingId && (
          <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-md p-6 mb-8 border-2 border-blue-500">
            <h2 className="text-2xl font-semibold mb-4 text-black dark:text-zinc-50">
              Edit Transaction
            </h2>
            <form onSubmit={handleUpdate} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditFormData({ ...editFormData, transaction: e.target.value })
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-50"
                  placeholder="Enter transaction description"
                  required
